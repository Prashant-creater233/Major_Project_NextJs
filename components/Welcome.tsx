...
function Welcome({nextStep}: propType){
  return (
    ...
    >
      ...
      <h1 className='text-4xl md:text-5xl font-extrabold text-green-700'>Grovana</h1>
    </motion.div>
    ...
    >
      Your one-step destination for fresh groceries, organic produce, and daily essentials delievered right to your doorstep
    </motion.p>
    <motion.div
    initial={{
      opacity: 0,
    ...
    >
      <ShoppingBasket className='w-24 h-24 mid:w-32 text-green-600 drop-shadow-md'/>
      <Bike className='w-24 h-24 mid:w-32 text-orange-500 drop-shadow-md'/>
    </motion.div>
